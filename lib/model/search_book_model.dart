class SearchBookDataModel {
  List<SearchBookDataModelData>? data;

  SearchBookDataModel({this.data});

  SearchBookDataModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <SearchBookDataModelData>[];
      json['data'].forEach((v) {
        data!.add(new SearchBookDataModelData.fromJson(v));
      });
    }
  }
...
class SearchBookDataModelData {
  ...
  SearchBookDataModelData.fromJson(Map<String, dynamic> json) {
    bookId = json['book_id'];
